...
async function seed() {
  ...
  await Profile.findOneAndUpdate(
    {},
    {
      ...
      bio: "Amit started out assisting bridal makeup artists across Mumbai before building his own studio, and over six years (and counting) has become known for blending traditional Indian bridal artistry — bold eyes, rich color, jewellery-ready skin — with a clean, modern finish for editorial and red-carpet work.",
      ...
      address: 'Studio 4, Pali Hill Road, Bandra West',
      city: 'Mumbai, Maharashtra 400050',
      mapsUrl: 'https://maps.google.com/?q=Pali+Hill+Road+Bandra+West+Mumbai',
